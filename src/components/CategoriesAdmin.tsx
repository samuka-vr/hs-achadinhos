...
export default function CategoriesAdmin() {
  ...
  return (
    <>
      <div className="admin-page-heading"><div><span className="admin-eyebrow">ORGANIZAÇÃO</span><h1>Categorias</h1><p>Crie uma navegação visual, organizada e fácil de explorar.</p></div><button className="admin-button" onClick={createNew}><Icon name="plus" />Nova categoria</button></div>
